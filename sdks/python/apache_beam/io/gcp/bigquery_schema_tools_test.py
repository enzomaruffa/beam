...
class TestBigQueryToSchema(unittest.TestCase):
  ...
  def test_datetime_with_various_formats(self):
    """Test DATETIME type with various format patterns."""
    fields = [
        bigquery.TableFieldSchema(
            name='basic_time', type='DATETIME', mode="NULLABLE"),
        bigquery.TableFieldSchema(
            name='with_microseconds', type='DATETIME', mode="NULLABLE"),
        bigquery.TableFieldSchema(
            name='midnight', type='DATETIME', mode="NULLABLE"),
        bigquery.TableFieldSchema(
            name='end_of_day', type='DATETIME', mode="NULLABLE")
    ]
    schema = bigquery.TableSchema(fields=fields)

    usertype = bigquery_schema_tools.generate_user_type_from_bq_schema(schema)

    # All DATETIME fields should map to Optional[str]
    expected_annotations = {
        'basic_time': typing.Optional[str],
        'with_microseconds': typing.Optional[str],
        'midnight': typing.Optional[str],
        'end_of_day': typing.Optional[str]
    }
